  ...
  return (
    <div className="relative">
      <button
        ...
        className={'p-2 border dark:border-none rounded-full bg-white dark:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-gray-400 dark:focus:ring-offset-gray-900 dark:focus:ring-gray-500'}
      >
