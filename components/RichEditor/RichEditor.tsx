  ...
  return (
    ...
    >
      <div className={'flex flex-wrap items-center p-0.5 border-b border-gray-300 dark:border-gray-600'}>
        ...
        >
          <Bold
            className={`w-3 h-3 sm:w-4 sm:h-4 ${isActive('bold') ?
              'text-blue-500' : 'text-gray-700 dark:text-blue-400'}`}
          />
        </button>
        <button
          onClick={() => editor.chain().focus().toggleItalic().run()}
          disabled={!editor.can().chain().focus().toggleItalic().run()}
          className={`p-1 sm:p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-700 ${isActive('italic') ? 'bg-gray-200 dark:bg-gray-600' : ''
          }`}
          type={'button'}
        >
          <Italic
            className={`w-3 h-3 sm:w-4 sm:h-4 ${isActive('italic') ?
              'text-blue-500' : 'text-gray-700 dark:text-blue-400'}`}
          />
        </button>
        <button
          ...
          className={`p-1 sm:p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-700 ${isActive('strike') ? 'bg-gray-200 dark:bg-gray-600' : ''
          }`}
          type={'button'}
        >
          <Strikethrough
            className={`w-3 h-3 sm:w-4 sm:h-4 ${isActive('strike') ?
              'text-blue-500' : 'text-gray-700 dark:text-blue-400'}`}
          />
        </button>
        ...
        <button
          ...
          className={`p-1 sm:p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-700 ${isActive('heading_1') ? 'bg-gray-200 dark:bg-gray-600' : ''
          }`}
          type={'button'}
        >
          <Heading1
            className={`w-3 h-3 sm:w-4 sm:h-4 ${isActive('heading_1') ?
              'text-blue-500' : 'text-gray-700 dark:text-blue-400'}`}
          />
        </button>
        <button
          onClick={() => editor.chain().focus().toggleHeading({level: 2}).run()}
          className={`p-1 sm:p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-700 ${isActive('heading_2') ? 'bg-gray-200 dark:bg-gray-600' : ''
          }`}
          type={'button'}
        >
          <Heading2
            className={`w-3 h-3 sm:w-4 sm:h-4 ${isActive('heading_2') ?
              'text-blue-500' : 'text-gray-700 dark:text-blue-400'}`}
          />
        </button>
        <button
          onClick={() => editor.chain().focus().toggleHeading({level: 3}).run()}
          className={`p-1 sm:p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-700 ${isActive('heading_3') ? 'bg-gray-200 dark:bg-gray-600' : ''
          }`}
          type={'button'}
        >
          <Heading3
            className={`w-3 h-3 sm:w-4 sm:h-4 ${isActive('heading_3') ?
              'text-blue-500' : 'text-gray-700 dark:text-blue-400'}`}
          />
        </button>
        <div className='mx-1 w-px h-6 bg-gray-300 dark:bg-gray-600'/>
        <button
          ...
          className={`p-1 sm:p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-700 ${isActive('textAlign_left') ? 'bg-gray-200 dark:bg-gray-600' : ''
          }`}
          type={'button'}
        >
          <AlignLeft
            className={`w-3 h-3 sm:w-4 sm:h-4 ${isActive('textAlign_left') ?
              'text-blue-500' : 'text-gray-700 dark:text-blue-400'}`}
          />
        </button>
        <button
          onClick={() => editor.chain().focus().setTextAlign('center').run()}
          className={`p-1 sm:p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-700 ${isActive('textAlign_center') ? 'bg-gray-200 dark:bg-gray-600' : ''
          }`}
          type={'button'}
        >
          <AlignCenter
            className={`w-3 h-3 sm:w-4 sm:h-4 ${isActive('textAlign_center') ?
              'text-blue-500' : 'text-gray-700 dark:text-blue-400'}`}
          />
        </button>
        <button
          onClick={() => editor.chain().focus().setTextAlign('right').run()}
          className={`p-1 sm:p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-700 ${isActive('textAlign_right') ? 'bg-gray-200 dark:bg-gray-600' : ''
          }`}
          type={'button'}
        >
          <AlignRight
            className={`w-3 h-3 sm:w-4 sm:h-4 ${isActive('textAlign_right') ?
              'text-blue-500' : 'text-gray-700 dark:text-blue-400'}`}
          />
        </button>
        <button
          onClick={() => editor.chain().focus().setTextAlign('justify').run()}
          className={`p-1 sm:p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-700 ${isActive('textAlign_justify') ? 'bg-gray-200 dark:bg-gray-600' : ''
          }`}
          type={'button'}
        >
          <AlignJustify
            className={`w-3 h-3 sm:w-4 sm:h-4 ${isActive('textAlign_justify') ?
              'text-blue-500' : 'text-gray-700 dark:text-blue-400'}`}
          />
        </button>
        <div className={'mx-1 w-px h-6 bg-gray-300 dark:bg-gray-600'}/>
        ...
        <button
          ...
          className={`p-1 sm:p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-700 ${isActive('bulletList') ? 'bg-gray-200 dark:bg-gray-600' : ''
          }`}
          type={'button'}
        >
          <List
            className={`w-4 h-4 sm:w-5 sm:h-5 ${isActive('bulletList') ?
              'text-blue-500' : 'text-gray-700 dark:text-blue-400'}`}
          />
        </button>
        <button
          onClick={() => editor.chain().focus().toggleOrderedList().run()}
          className={`p-1 sm:p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-700 ${isActive('orderedList') ? 'bg-gray-200 dark:bg-gray-600' : ''
          }`}
          type={'button'}
        >
          <ListOrdered
            className={`w-4 h-4 sm:w-5 sm:h-5 ${isActive('orderedList') ?
              'text-blue-500' : 'text-gray-700 dark:text-blue-400'}`}
          />
        </button>
        <div className={'mx-1 w-px h-6 bg-gray-300 dark:bg-gray-600'}/>
        ...
        >
          <Highlighter
            className={`w-3 h-3 sm:w-4 sm:h-4 ${isActive('highlight') ?
              'text-blue-500' : 'text-gray-700 dark:text-blue-400'}`}
          />
        </button>
      </div>
