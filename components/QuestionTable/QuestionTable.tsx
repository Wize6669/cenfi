...
interface QuestionTable {
  ...
  answer: number;
  options: { id: number; content: object }[];
  categoryId?: number;
  categoryName?: string;
  simulatorId?: string;
}
...
export default function QuestionTable({handlePageChange, handlePageSizeChange, data, pagination}: PropsTable) {
  ...
  const columns: ColumnDef<QuestionTable, any>[] = [
    ...
    columnHelper.accessor('content', {
      ...
      header: 'PREGUNTA',
      cell: info => (
        <div className='text-center max-w-[225px] overflow-hidden overflow-ellipsis whitespace-nowrap'>
    ...
    columnHelper.accessor('answer', {
      ...
      cell: info => (
        <div className='text-center'>
          ...
          >
          Opción {info.row.original.answer}
          </span>
        </div>
      ),
      size: 100,
