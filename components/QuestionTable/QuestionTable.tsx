...
export default function QuestionTable({handlePageChange, handlePageSizeChange, data, pagination}: PropsTable) {
    ...
    const columnHelper = createColumnHelper<QuestionTable>();

    const columns: ColumnDef<QuestionTable, any>[] = [
        ...
        columnHelper.accessor('justification', {
            ...
            cell: info => {
                ...
                // Verifica si la justificación está vacía o es un objeto vacío
            ...
            cell: info => {
                ...
                if (correctOptionIndex === -1) {
                    return (
                        <div className='text-center'>
                    <span
              className='px-2 py-1 rounded-full text-xs font-semibold bg-gray-200 text-gray-600 dark:bg-gray-800 dark:text-gray-400'>
            Sin opción correcta
                     </span>
                        </div>
                    );
                                ...
                                <Dialog.Panel
                                    ...
                                    <div className='mt-2'>
                                        <p className='text-sm text-gray-500 dark:text-gray-400'>
                                            ¿Estás seguro de que deseas eliminar esta pregunta? Esta acción no se puede
                                            deshacer.
                                        </p>
                                    </div>
